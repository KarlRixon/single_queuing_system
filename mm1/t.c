...
int main(){
    ...
    printf("01: %f\n", (float)c1 / (float)n);
    printf("12: %f\n", (float)c2 / (float)n - (float)c1 / (float)n);
    printf("23: %f\n", (float)c3 / (float)n - (float)c2 / (float)n);
    printf("34: %f\n", (float)c4 / (float)n - (float)c3 / (float)n);
    printf("45: %f\n", (float)c5 / (float)n - (float)c4 / (float)n);
